...
// side of treevial and compile. Nothing inside this module can prove that,
// because in-module code may freely import internal packages and may name
// internal types in exported signatures — both of which an outside consumer
// cannot do.
